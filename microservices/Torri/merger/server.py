...
class KafkaConsumerWorker:
    ...
    def _handle_message(self, msg):
        ...
        job_logger = get_logger("torri.merger.job", job_id=request.job_id, trace_id=request.trace_id)
            ...
            if request.action == MergeAction.SPECULATIVE_MERGE:
                ...
                items = [
                    SpeculativeMergeItem(
                        ...
                        patchset_ref=request.patchset_ref,
                        strategy="merge"
                    )
                ]
                ...
                if request.files_to_read:
                    ...
                    files_content = repo.read_files_at_ref(request.patchset_ref, request.files_to_read)
