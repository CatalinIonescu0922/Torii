...
from ansible.plugins.action.command import ActionModule as _BuiltinCommand
...
class ActionModule(_BuiltinCommand):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        result = super(_BuiltinCommand, self).run(tmp, task_vars)
